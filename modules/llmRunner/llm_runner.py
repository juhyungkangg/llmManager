...
class LLMRunnerWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.input_path.setText("C:/Users/Ju Hyung Kang/Desktop/processed/processed/news")
        ...
        self.output_path.setText("C:/Users/Ju Hyung Kang/Desktop/llm_processed/news")
        ...
        self.batch_size.setRange(1, 1000000)
        self.batch_size.setValue(50000)
