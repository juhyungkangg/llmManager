...
class LangchainManagerWidget(AbstractWidget):
    ...
    def display_chain_details(self, chain_name):
        ...
        details = (
            ...
            f"<b>System Prompt Template:</b> {prompt_details.get('system_prompt_template', 'N/A')}<br>"
            f"<b>User Prompt Template:</b> {prompt_details.get('user_prompt_template', 'N/A')}<br>"
